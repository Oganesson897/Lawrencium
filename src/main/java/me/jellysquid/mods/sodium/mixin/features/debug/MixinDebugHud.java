...
public abstract class MixinDebugHud {
    ...
    private ArrayList<String> redirectRightTextEarly(Object[] elements) {
        ...
        strings.add(TextFormatting.UNDERLINE + lawrencium$getFormattedVersionText());
        strings.add("");
        strings.addAll(lawrencium$getChunkRendererDebugStrings());
        ...
        for (int i = 0; i < strings.size(); i++) {
            ...
            if (str.startsWith("Allocated:")) {
                strings.add(i + 1, lawrencium$getNativeMemoryString());
    ...
    @Unique
    private static String lawrencium$getFormattedVersionText() {
    ...
    @Unique
    private static List<String> lawrencium$getChunkRendererDebugStrings() {
    ...
    @Unique
    private static String lawrencium$getNativeMemoryString() {
